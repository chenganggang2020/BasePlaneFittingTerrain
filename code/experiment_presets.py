...
PAPER_EXPERIMENT_PRESETS = OrderedDict({
    "peiv10": ExperimentPreset(
        name="peiv10",
        point_cloud_dir="data/point_clouds_output_peiv",
        output_root="results/paper/peiv10",
        initial_plane_slope=10,
        initial_plane_interception=30,
    ),
    "peiv15": ExperimentPreset(
        name="peiv15",
        point_cloud_dir="data/point_clouds_output_peiv15",
        output_root="results/paper/peiv15",
    ...
    "peiv35": ExperimentPreset(
        name="peiv35",
        point_cloud_dir="data/point_clouds_output_peiv35",
        output_root="results/paper/peiv35",
        initial_plane_slope=35,
        initial_plane_interception=30,
    ),
    "structured35": ExperimentPreset(
        name="structured35",
        point_cloud_dir="data/point_clouds_output_structured35",
        output_root="results/paper/structured35",
        initial_plane_slope=35,
        initial_plane_interception=30,
    ),
})
